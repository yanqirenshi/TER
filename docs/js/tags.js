...
riot.tag2('api_page_tab_readme', '<section class="section"> <div class="container"> <h1 class="title">README</h1> <h2 class="subtitle"></h2> <div class="contents"> <table class="table is-bordered is-striped is-narrow is-hoverable"> <thead> <tr> <th rowspan="2">Method</th> <th rowspan="2">Path</th> <th rowspan="2">実装</th> <th colspan="3">権限</th> <th rowspan="2">Description</th> </tr> <tr> <th>Owner</th> <th>Writer</th> <th>Reader</th> </tr> </thead> <tbody> <tr each="{obj in list}"> <td>{obj.method}</td> <td><code>{obj.path}</code></td> <td>{obj.implementation   ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.authority.owner  ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.authority.writer ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.authority.reader ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.description}</td> </tr> </tbody> </table> </div> </div> </section>', '', '', function(opts) {
     this.list = [
