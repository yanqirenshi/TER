...
riot.tag2('api_page_tab_readme', '<section class="section"> <div class="container"> <h1 class="title">README</h1> <h2 class="subtitle"></h2> <div class="contents"> <table class="table is-bordered is-striped is-narrow is-hoverable"> <thead> <tr> <th>Method</th> <th>Path</th> <th>実装</th> <th>Description</th> </tr> </thead> <tbody> <tr each="{obj in list}"> <td>{obj.method}</td> <td><code>{obj.path}</code></td> <td>{obj.implementation ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.description}</td> </tr> </tbody> </table> </div> </div> </section>', '', '', function(opts) {
     this.list = [
         ...
         { path: "/ter/campuses/:campus-id/environments",                     method: "GET",  implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/cameras/:camera-id/look-at",       method: "POST", implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/cameras/:camera-id/magnification", method: "POST", implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/entities",                         method: "GET",  implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/entities/:entity-id/location",     method: "POST", implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/identifiers",                      method: "GET",  implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/attributes",                       method: "GET",  implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/ports",                            method: "GET",  implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/ports/:port-id/location",          method: "POST", implementation: true, description: '' },
         { path: "/ter/campuses/:campus-id/edges",                            method: "GET",  implementation: true, description: '' },
