...
riot.tag2('api_page_tab_readme', '<section class="section"> <div class="container"> <h1 class="title">README</h1> <h2 class="subtitle"></h2> <div class="contents"> <table class="table is-bordered is-striped is-narrow is-hoverable"> <thead> <tr> <th>Method</th> <th>Path</th> <th>実装</th> <th>Description</th> </tr> </thead> <tbody> <tr each="{obj in list}"> <td>{obj.method}</td> <td><code>{obj.path}</code></td> <td>{obj.implementation ? ⁗○⁗ : ⁗×⁗}</td> <td>{obj.description}</td> </tr> </tbody> </table> </div> </div> </section>', '', '', function(opts) {
     this.list = [
         ...
         { path: "/er/:schema_code/environments",                                         method: "GET",  implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/schemas/:schema-id/camera/:camera-id/look-at",                      method: "POST", implementation: true, description: '' },
         { path: "/er/schemas/:schema-id/camera/:camera-id/magnification",                method: "POST", implementation: true, description: '' },
         { path: "/er/:schema-code/tables/:table-code/columns/:column-code/logical-name", method: "POST", implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema-code/tables/:table-code/description",                       method: "POST", implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema_code/tables/:code/position",                                method: "POST", implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema_code/tables/:code/size",                                    method: "POST", implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema-code/columns/instance/:id/description",                     method: "POST", implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema_code/nodes",                                                method: "GET",  implementation: true, description: '修正要：/er → /er/schemas' },
         { path: "/er/:schema_code/edges",                                                method: "GET",  implementation: true, description: '修正要：/er → /er/schemas' },
     ];
});
