<page-usage_tab-ter>
  ...
  (tx-add-attributes graph
    ...
    <section class="section">
        <div class="container">
            <h1 class="title is-4">サブセットの追加</h1>
            <h2 class="subtitle"></h2>

            <div class="contents">
                <p><pre>tx-add-subset</pre> を使います。(未実装)</p>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title is-4">dtl の追加</h1>
            <h2 class="subtitle"></h2>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title is-4">再帰の追加</h1>
            <h2 class="subtitle"></h2>

            <div class="contents">
                <p>tx-add-recursion</p>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title is-4">Disctionaries</h1>
            <h2 class="subtitle"></h2>
